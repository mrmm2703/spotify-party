...
var endpoint = "https://accounts.spotify.com/authorize?client_id=d7bc09b9fc624ecfb3345d126c96f61f&redirect_uri=https:%2F%2Ffourone.ddns.net:3000&response_type=token&scope=streaming%20user-read-email%20user-modify-playback-state%20user-read-private&show_dialog=true"
var my_chatroom
...
function onLoad() {
    ...
    if(window.location.hash) {
        ...
        if (window.location.hash == "#admin1497") {
            window.location.replace("https://fourone.ddns.net:3000/admin1497.html")
        }
